          ...
          Dropdown: ({ value, onChange, children, ...props }: DropdownProps) => {
            ...
            if (props.name === "months") {
              return (
                ...
                >
                  <SelectTrigger className="h-7 w-auto min-w-[7rem] px-2 text-xs focus:ring-0 border-0 bg-transparent font-medium">
            ...
            if (props.name === "years") {
              ...
              return (
                <Select
                  ...
                  onValueChange={handleSelect}
                >
                  <SelectTrigger className="h-7 w-[4.5rem] px-2 text-xs focus:ring-0 border-0 bg-transparent font-medium">
