...
export const BOMBONIERE_ITEMS_DEFAULT: { id: string; name: string; price: number; imageUrl: string, aiHint: string }[] = [
    ...
    { id: 'fanta-lata', name: 'Fanta Lata', price: 5.00, imageUrl: 'https://picsum.photos/seed/fanta-lata/200/200', aiHint: 'soda can' },
    { id: 'guarana-lata', name: 'Guaraná Lata', price: 5.00, imageUrl: 'https://picsum.photos/seed/guarana-lata/200/200', aiHint: 'soda can' },
    ...
    { id: 'agua-com-gas', name: 'Água com Gás', price: 3.50, imageUrl: 'https://picsum.photos/seed/agua-com-gas/200/200', aiHint: 'water bottle' },
    { id: 'chocolate', name: 'Chocolate', price: 4.00, imageUrl: 'https://picsum.photos/seed/chocolate/200/200', aiHint: 'chocolate bar' },
    { id: 'bala', name: 'Balas', price: 0.50, imageUrl: 'https://picsum.photos/seed/bala/200/200', aiHint: 'candies' },
